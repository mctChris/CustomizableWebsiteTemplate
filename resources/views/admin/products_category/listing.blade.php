...
@section('buttons')
    ...
    @if($config['links']['listing']['back'])
    <a class="btn btn-secondary" href="{{ $config['links']['listing']['back'] }}">Back</a>
    @endif
                    ...
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th>Title</th>
                                {{-- <th class="col-common">Has Child Category</th> --}}
                                <th>Belongs</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td align="center"><a href="{{ $record->link }}">{{ $record->has_child_category ? 'Yes' : 'No' }}</a></td> --}}
                                <td><a href="{{ $record->link }}">{{ $record->child_count() }}</a></td>
